export const en = {
  ...
  'nav.home': 'Home',
  'nav.map': 'Map',
  'nav.explore': 'Explore Music',
  'nav.about': 'About',
  
  // Landing Page
  'landing.title': 'Hong Kong Music Atlas',
  'landing.subtitle': 'Explore Hong Kong\'s cultural geography through Cantonese pop music',
  'landing.description': 'Discover how Canto-pop songs reference specific neighborhoods, landmarks, and streets across Hong Kong. Each pin on the map represents a lyrical reference, creating a dynamic storytelling experience of the city\'s musical landscape.',
  ...
  'about.technical.frontend.value': 'React with modern hooks and context',
  ...
  'about.technical.data.value': 'Curated database of 20+ songs (scalable)',
